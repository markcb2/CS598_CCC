...
public class CreateCSVQueryResultsForGroup2 {
    ...
    public void start(){
        ...
        Dataset<Row> query2Dot1FilteredQueryResults_df = spark.read().format("parquet").load("/tmp/cs598ccc/queryResults/group2Dot1_filtered");
        ...
        Dataset<Row> query2Dot2FilteredQueryResults_df = spark.read().format("parquet").load("/tmp/cs598ccc/queryResults/group2Dot2_filtered");
        ...
        Dataset<Row> query2Dot4QueryResults_df = spark.read().format("parquet").load("/tmp/cs598ccc/queryResults/group2Dot4");
        ...
        query2Dot1FilteredQueryResults_df.coalesce(1)
                ...
                .option("sep", ",")
                .option("header", "true")
                .save("/tmp/cs598ccc/queryResults/group2Dot1_filtered_csv");
        ...
        query2Dot2FilteredQueryResults_df.coalesce(1)
                ...
                .option("sep", ",")
                .option("header", "true")
                .save("/tmp/cs598ccc/queryResults/group2Dot2_filtered_csv");
        ...
        query2Dot4QueryResults_df.coalesce(1)
                ...
                .option("sep", ",")
                .option("header", "true")
                .save("/tmp/cs598ccc/queryResults/group2Dot4_csv");
