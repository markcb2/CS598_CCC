...
public class Group3QueryProcessor {

    private static Logger logger = Logger.getLogger(Group3QueryProcessor.class);

    public static void main(String[] args) {
        logger.info("Starting Group 3 Queries");
        Group3QueryProcessor app = new Group3QueryProcessor();
        app.start();
    }
